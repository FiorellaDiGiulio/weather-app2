/**
 * Översätter Open-Meteo väderkoder till svenska väderbeskrivningar med emojis.
 *
 * @param {number} code - Väderkoden från Open-Meteo API
 * @returns {string} Svenska väderbeskrivningen motsvarande koden
 */
